...
<div class="container px-4 mx-auto">
        ...
        <div class="relative overflow-hidden transition-all duration-300 bg-white border border-pink-100 shadow-sm rounded-xl hover:shadow-md group">
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-medium text-gray-500">Near Expiry</p>
    ...
    <div class="mt-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold text-gray-700">Products Near Expiry</h2>
                ...
                <table class="min-w-full divide-y divide-pink-100">
                    <thead class="bg-pink-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Expiry Date</th>
                            <th scope="col" class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Days Left</th>
                        </tr>
                    </thead>
    ...
    <div class="mt-8 mb-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold text-gray-700">Recent Stock Movements</h2>
