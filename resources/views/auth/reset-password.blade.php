            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-pink-50 text-pink-600">Need help?</span>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center text-sm">
                    <p class="text-pink-600">
                        Contact
                        <a href="mailto:support@itseeystore.com" class="text-primary hover:text-primary-dark font-medium">
                            support@itseeystore.com
                        </a>
                    </p>
                </div>
            </div>
