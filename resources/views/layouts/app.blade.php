                ...
                <div
                    ...
                    <div class="flex-shrink-0 p-4 border-t border-gray-200">
                        <div class="flex items-center">
                            <div class="w-10 h-10 overflow-hidden bg-primary rounded-full flex items-center justify-center text-white">
                ...
                <div class="flex flex-col w-64">
                    <div class="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
                        ...
                        <div class="flex items-center justify-between flex-shrink-0 p-4 border-t border-gray-200">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="p-1 text-primary-dark hover:text-primary-darker rounded-full hover:bg-pink-50">
